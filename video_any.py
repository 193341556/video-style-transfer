...
import cv2
import os
from stylize_any import stylize_folder_single
import numpy as np
...
STYLE_VIDEO_NAME = "out.mp4"
STYLE_PATH = "transforms/any_night.pth"
FLOW_PATH="flow/"
BATCH_SIZE = 1
...
def video_transfer(video_path, style_path):
    ...
    stylize_folder_single(STYLE_IMAGE_PATH,style_path, "frames/content_folder/", STYLE_FRAME_SAVE_PATH)
